...
function(llvm_ExternalProject_Add name source_dir)
  ...
  if(ARG_USE_TOOLCHAIN AND NOT CMAKE_CROSSCOMPILING)
    ...
    if(llvm-ar IN_LIST TOOLCHAIN_TOOLS)
      if(is_msvc_target)
        list(APPEND compiler_args -DCMAKE_AR=${LLVM_RUNTIME_OUTPUT_INTDIR}/llvm-${CMAKE_INSTALL_LIBDIR}${CMAKE_EXECUTABLE_SUFFIX})
      else()
    ...
    if(llvm-ranlib IN_LIST TOOLCHAIN_TOOLS)
      list(APPEND compiler_args -DCMAKE_RANLIB=${LLVM_RUNTIME_OUTPUT_INTDIR}/llvm-ran${CMAKE_INSTALL_LIBDIR}${CMAKE_EXECUTABLE_SUFFIX})
    endif()
