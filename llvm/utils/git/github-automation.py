...
Please let us know when you are happy for this to be merged, and one of the reviewers can
merge it on your behalf.
...
pr_merge_on_behalf_information_parser = subparsers.add_parser("pr-merge-on-behalf-information")
pr_merge_on_behalf_information_parser.add_argument("--issue-number", type=int, required=True)
